...
public class IFSCreatePanel extends JPanel {
	...
	private ItemList<ItemFromSupplier> itemList;
	private MainWindow mainWindow;

	/**
	 * Create the panel.
	 */
	public IFSCreatePanel(MainWindow mw) {
		this.mainWindow = mw;
		itemList = mw.IFSList;
		...
		JLabel lblNewLabel_3 = new JLabel("Create Supplier Item");
		...
		txtType.setText("ItemFromSupplier");
		...
		txtSellByDate.setText("" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("YYYY-MM-dd")));
		...
		txtExpDate.setText("" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("YYYY-MM-dd")));
...
//		txtSupplierID.setText("250415190000518");
...
//		supplierComboBox.setColumns(20);
	...
	public void save() {
		...
		ItemFromSupplier item = new ItemFromSupplier();

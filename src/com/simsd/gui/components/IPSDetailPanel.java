...
public class IPSDetailPanel extends JPanel {

	private static final long serialVersionUID = 1L;
	private MainWindow mainWindow;
	private JTextField txtName, txtDesc, txtType, txtProducedDate, txtSellByDate, txtExpDate, txtPricePerUnit, txtUnit, txtQuantity;
	private ItemProducedInStore ipsItem;
	
	/**
	 * Create the panel.
	 */
	public IPSDetailPanel(MainWindow mw) {
		this.mainWindow = mw;
		...
		JLabel lblNewLabel_3 = new JLabel("Store-Produced Item's Detail");
		...
		JLabel lblNewLabel9 = new JLabel("Produced Date:");
...
//		txtSupplierID = new JTextField();
	...
	public void setItem(ItemProducedInStore item) {
		this.ipsItem = item;
...
//		txtExpDate.setText(item.getExpDate().format(DateTimeFormatter.ofPattern("YYYY-MM-dd")));
		...
		txtProducedDate.setText(""+ item.getProduceDate());
	...
	public void delete() {
	    ...
	    if (confirm == JOptionPane.YES_OPTION) {
	        mainWindow.IPSList.remove(ipsItem);
	        mainWindow.IPSList.save();
	...
	public void save() {
		...
		ipsItem.setName(txtName.getText());
		ipsItem.setDescription(txtDesc.getText());
		ipsItem.setType(txtType.getText());
		ipsItem.setSellByDate(LocalDate.parse(txtSellByDate.getText(), DateTimeFormatter.ofPattern("yyyy-M-d")));
		ipsItem.setExpDate(LocalDate.parse(txtExpDate.getText(), DateTimeFormatter.ofPattern("yyyy-M-d")));
		ipsItem.setPricePerUnit(Float.parseFloat(txtPricePerUnit.getText()));
		ipsItem.setUnit(txtUnit.getText());
		ipsItem.setQuantity(Float.parseFloat(txtQuantity.getText()));
		ipsItem.setProduceDate(LocalDate.parse(txtProducedDate.getText(), DateTimeFormatter.ofPattern("yyyy-M-d")));
		//ToDo setExpired
		ipsItem.setExpired(false);
